...
// @interface NSSegmentedCell(InkTheme)
@interface Ink(NSSegmentedCell)
@end
@implementation Ink(NSSegmentedCell)


// - (NSColor*) textColor
- (NSColor*) _overrideNSSegmentedCellMethod_textColor
{
  MILKLOG(@"_overrideNSSegmentedCellMethod_textColor");
  //IT DOES NOT WORKS
...
- (void) _overrideNSSegmentedCellMethod__drawBorderAndBackgroundWithFrame: (NSRect)cellFrame
                                    inView: (NSView*)controlView
{
  MILKLOG(@"_overrideNSSegmentedCellMethod__drawBorderAndBackgroundWithFrame");
  NSSegmentedCell *xself = (NSSegmentedCell*) self;
  CGFloat radius = 4;
...
{
  MILKLOG(@"_overrideNSSegmentedCellMethod_drawWithFrame");
