#include "Ink+Button.h"
#include "InkWindowButton.h"
...
// TS: forward dec
@interface NSWindow(InkTheme)
- (void) MILKsetDefaultButtonCell: (NSButtonCell *)aCell;
@end

@implementation Ink(NSWindow)
...
{
  InkWindowButton *newButton;

  MILKLOG(@"NSWindow+Ink standardWindowButton:forStyleMask:");

  switch (button)
    {
      case NSWindowCloseButton:
        newButton = [[InkWindowButton alloc] init];
        [newButton setBaseColor: [NSColor colorWithCalibratedRed: 0.302 green: 0.573 blue: 0.00 alpha: 1]];
      ...
      case NSWindowMiniaturizeButton:
        newButton = [[InkWindowButton alloc] init];
        [newButton setBaseColor: [NSColor colorWithCalibratedRed: 0.1 green: 0.3 blue: 0.7 alpha: 1]];
      ...
      case NSWindowZoomButton:
        // FIXME
        newButton = [[InkWindowButton alloc] init];
        [newButton setBaseColor: [NSColor colorWithCalibratedRed: 0.678 green: 0.222 blue: 0.756 alpha: 1]];
...
@implementation NSWindow(InkTheme)
