...
@implementation InkScrollerArrowCell
...
- (void) drawBezelWithFrame: (NSRect)cellFrame inView: (NSView *)controlView
{
  ...
  [(Ink*)[GSTheme theme] drawPathButton: path
                               in: self
                            state: buttonState];
}
