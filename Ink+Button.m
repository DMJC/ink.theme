...
NSString * const kInkIsDefaultButton = @"kInkIsDefaultButton";
NSString * const kInkPulseProgressKey = @"kInkPulseProgressKey";

@implementation NSButtonCell(InkDefaultButtonAnimation)
- (void)setIsDefaultButton:(NSNumber*) val
{
  objc_setAssociatedObject(self, kInkIsDefaultButton, val, OBJC_ASSOCIATION_COPY);
}

- (NSNumber *) isDefaultButton
{
	return objc_getAssociatedObject(self, kInkIsDefaultButton);
}
- (BOOL)defaultButton
{
...
{
	objc_setAssociatedObject(self, kInkPulseProgressKey, pulseProgress, OBJC_ASSOCIATION_COPY);
}

- (NSNumber*)pulseProgress
{
	return objc_getAssociatedObject(self, kInkPulseProgressKey);
}
@end

@implementation Ink(InkButton)
