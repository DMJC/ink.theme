  ...
  if (type == NSLinearSlider)
    {
      ...
      //// Color Declarations
      NSColor* strokeBaseColor = [NSColor colorWithCalibratedRed: 0.267 green: 0.267 blue: 0.267 alpha: 1];
...
- (void) drawKnobInCell: (NSCell *)cell
{
  ...
  r.origin.x -= 1;
  r.origin.y -= 1;
  NSColor	*color = [NSColor colorWithCalibratedRed: 0.1
                                             green: 0.1
                                              blue: 0.1
                                             alpha: 1];
