...
@interface Ink(InkProgressIndicator)

@end

@implementation Ink(InkProgressIndicator)
           ...
           if (!NSIsEmptyRect(r))
             {
               [self drawProgressIndicatorBarDeterminate: (NSRect)r withOrientation:[progress isVertical]];
                ...
                NSColor* strokeColor = [NSColor colorWithCalibratedRed: 0.376
                                                                green: 0.376
                                                                  blue: 0.376
                                                                alpha: 1];
...
- (void) drawProgressIndicatorBarDeterminate: (NSRect)bounds withOrientation:(BOOL) isVertical
{
  ...
  //// Color Declarations
  NSColor* baseColor = [NSColor colorWithCalibratedRed: 0.2 green: 0.2 blue: 0.2 alpha: .1];
