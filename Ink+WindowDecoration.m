...
@interface Ink(InkWindowDecoration)
...
@implementation Ink(InkWindowDecoration)
...
- (void) drawWindowBackground: (NSRect) frame view: (NSView*) view
{
  ...
  NSColor *borderColor = [Ink controlStrokeColor];
...
- (void)prepareTitleTextAttributes
{
  ...
  normalColor = [NSColor colorWithCalibratedRed: 0.9 green: 0.9 blue: 0.9 alpha: 1];
