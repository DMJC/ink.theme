...
@implementation Ink(InkSegmented)
                        ...
                        roundedRight: (BOOL)roundedRight
{
    ...
    // TS: unused
    // NSColor* buttonStroke = [Ink controlStrokeColor];
    NSColor* buttonFill = [NSColor colorWithCalibratedRed: 0.42 green: 0.42 blue: 0.42 alpha: 1];
    NSColor* buttonFillLight = [NSColor colorWithCalibratedRed: 0.337 green: 0.337 blue: 0.337 alpha: 1];
