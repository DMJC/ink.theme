...
#import "Ink.h"
#import "NSSearchFieldCell+Ink.h"
#import "Ink+Button.h"

#define ICON_WIDTH	16

@interface NSSearchFieldCell (InkTheme)
...
@implementation Ink(NSSearchFieldCell)
...
@implementation NSSearchFieldCell (InkTheme)
                                    ...
                                    inView: (NSView*)controlView
{
  ...
  NSColor* whiteColor = [NSColor colorWithCalibratedRed: 0
                                                  green: 0
                                                   blue: 0
                                                  alpha: 0.8];
  NSColor* clearColor = [NSColor colorWithCalibratedRed: 0
                                                  green: 0
                                                   blue: 0
                                                  alpha: 0];
  NSColor * strokeBaseColor = [Ink controlStrokeColor];
